...
# To compile the parallelized functions
...
Coefficient, Intercept = fitting_model(X_train, y_train, train_size)
...
print("Average time taken by parallel code = ", np.mean(time_taken), " seconds")
